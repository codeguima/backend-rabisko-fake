...
CREATE TABLE `users` (
  ...
  `userType` enum('cliente','tatuador') DEFAULT 'cliente',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (2,'@Jhonny','jhonny@gmail.com','$2b$10$xUJRGo49jHU.ASHy6y89/uBXinBvAs9kEuNVDKR4xWXmAAGotlKjO','2025-08-30 01:51:52.260841','2025-08-31 20:28:41.928627','tatuador');
